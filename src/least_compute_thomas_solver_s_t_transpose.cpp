#include "least_compute_thomas_solver_s_t_transpose.h"
...
void least_compute_thomas_solver_s_t_transpose<real_t, aligned_x>::precompute_values(std::unique_ptr<real_t[]>& b,
...
template <typename real_t, bool aligned_x>
void least_compute_thomas_solver_s_t_transpose<real_t, aligned_x>::prepare(const max_problem_t& problem)
{
	...
	std::cout << "Address of substrates_: " << substrates_.get() << std::endl;
	std::cout << "Address of substrates_ % 32: " << reinterpret_cast<std::uintptr_t>(substrates_.get()) % 32
			  << std::endl;
...
template <typename real_t, bool aligned_x>
void least_compute_thomas_solver_s_t_transpose<real_t, aligned_x>::tune(const nlohmann::json& params)
{
...
template <typename real_t, bool aligned_x>
void least_compute_thomas_solver_s_t_transpose<real_t, aligned_x>::initialize()
{
	if (problem_.dims >= 1)
...
auto least_compute_thomas_solver_s_t_transpose<real_t, aligned_x>::get_substrates_layout(
...
template <typename real_t, bool aligned_x>
auto least_compute_thomas_solver_s_t_transpose<real_t, aligned_x>::get_diagonal_layout(
	const problem_t<index_t, real_t>& problem, index_t n)
{
...
template <typename real_t, bool aligned_x>
void least_compute_thomas_solver_s_t_transpose<real_t, aligned_x>::solve_x()
{
	if (problem_.dims == 1)
	{
#pragma omp parallel
...
template <typename real_t, bool aligned_x>
void least_compute_thomas_solver_s_t_transpose<real_t, aligned_x>::solve_y()
{
	if (problem_.dims == 2)
	{
#pragma omp parallel
...
#pragma omp parallel
		solve_slice_y_3d<index_t>(substrates_.get(), by_.get(), cy_.get(), ey_.get(),
								  ...
								  work_items_, x_tile_size_);
	}
}

template <typename real_t, bool aligned_x>
void least_compute_thomas_solver_s_t_transpose<real_t, aligned_x>::solve_z()
{
#pragma omp parallel
...
template <typename real_t, bool aligned_x>
void least_compute_thomas_solver_s_t_transpose<real_t, aligned_x>::solve()
{
	if (problem_.dims == 1)
	{
#pragma omp parallel
...
template <typename real_t, bool aligned_x>
void least_compute_thomas_solver_s_t_transpose<real_t, aligned_x>::save(const std::string& file) const
{
...
template <typename real_t, bool aligned_x>
double least_compute_thomas_solver_s_t_transpose<real_t, aligned_x>::access(std::size_t s, std::size_t x, std::size_t y,
																			std::size_t z) const
{
	auto dens_l = get_substrates_layout<3>(problem_);
...
template class least_compute_thomas_solver_s_t_transpose<float, false>;
// template class least_compute_thomas_solver_s_t_transpose<double, false>;

template class least_compute_thomas_solver_s_t_transpose<float, true>;
// template class least_compute_thomas_solver_s_t_transpose<double, true>;
