...
void least_compute_thomas_solver_s<real_t>::precompute_values(std::unique_ptr<real_t[]>& b,
...
template <typename real_t>
void least_compute_thomas_solver_s<real_t>::prepare(const max_problem_t& problem)
{
...
template <typename real_t>
void least_compute_thomas_solver_s<real_t>::tune(const nlohmann::json& params)
{
...
template <typename real_t>
void least_compute_thomas_solver_s<real_t>::initialize()
{
	if (problem_.dims >= 1)
...
auto least_compute_thomas_solver_s<real_t>::get_substrates_layout(const problem_t<index_t, real_t>& problem)
{
	if constexpr (dims == 1)
...
template <typename real_t>
auto least_compute_thomas_solver_s<real_t>::get_diagonal_layout(const problem_t<index_t, real_t>& problem, index_t n)
{
...
template <typename real_t>
void least_compute_thomas_solver_s<real_t>::solve_x()
{
	if (problem_.dims == 1)
	{
#pragma omp parallel
...
template <typename real_t>
void least_compute_thomas_solver_s<real_t>::solve_y()
{
	if (problem_.dims == 2)
	{
#pragma omp parallel
...
template <typename real_t>
void least_compute_thomas_solver_s<real_t>::solve_z()
{
#pragma omp parallel
...
template <typename real_t>
void least_compute_thomas_solver_s<real_t>::solve()
{
	if (problem_.dims == 1)
	{
#pragma omp parallel
...
template <typename real_t>
void least_compute_thomas_solver_s<real_t>::save(const std::string& file) const
{
...
template <typename real_t>
double least_compute_thomas_solver_s<real_t>::access(std::size_t s, std::size_t x, std::size_t y, std::size_t z) const
{
	auto dens_l = get_substrates_layout<3>(problem_);
...
template class least_compute_thomas_solver_s<float>;
template class least_compute_thomas_solver_s<double>;
