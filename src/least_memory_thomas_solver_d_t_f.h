...
class least_memory_thomas_solver_d_t_f : public locally_onedimensional_solver,
										 public base_solver<real_t, least_memory_thomas_solver_d_t_f<real_t, aligned_x>>
...
public:
	least_memory_thomas_solver_d_t_f(bool use_intrinsics);
	...
	~least_memory_thomas_solver_d_t_f();
};
